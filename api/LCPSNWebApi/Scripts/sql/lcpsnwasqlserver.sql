...
CREATE TABLE [Feedbacks] (
    ...
    [IsLocked] bit NULL,
    [IsFeatured] bit NULL,
    [TypeFeedback] nvarchar(max) NULL,
    [StatusFeedback] nvarchar(max) NULL,
    [DateFeedbackCreated] datetime2 NULL,
    [DateFeedbackUpdated] datetime2 NULL,
    [DateFeedbackDeleted] datetime2 NULL,
    [Counter] int NULL,
    [UserId] int NULL,
