...
if exist "%USERPROFILE%\LCPSNWebApiDB.mdf" ( 
	del /f /q "%USERPROFILE%\LCPSNWebApiDB.mdf"
)

if exist "%USERPROFILE%\LCPSNWebApiDB_log.ldf" (
	del /f /q "%USERPROFILE%\LCPSNWebApiDB_log.ldf"
)
...
:copyfiles
	if exist "%USERPROFILE%\LCPSNWebApiDB.mdf" (
		copy "%USERPROFILE%\LCPSNWebApiDB.mdf" "%MYLCPPATH%\Databases\SQLServer"
	)

	if exist "%USERPROFILE%\LCPSNWebApiDB_log.ldf" (
		copy "%USERPROFILE%\LCPSNWebApiDB_log.ldf" "%MYLCPPATH%\Databases\SQLServer"
	)
goto:eof
